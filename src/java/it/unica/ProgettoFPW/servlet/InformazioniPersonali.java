 ...
 * @author fpw
 */
@WebServlet(name = "InformazioniPersonali", urlPatterns = {"/InformazioniPersonali"})
public class InformazioniPersonali extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("pagina_pers.jsp").forward(request,response);
