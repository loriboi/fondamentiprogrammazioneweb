 ...
 * @author fpw
 */
@WebServlet(name = "FattureUtenteServlet", urlPatterns = {"/FattureUtenteServlet"})
public class FattureUtenteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Fattura> fatture = FatturaFactory.getInstance().getAllFattureUtente(id_user);
        ...
        request.getRequestDispatcher("fatture_utente.jsp").forward(request,response);
