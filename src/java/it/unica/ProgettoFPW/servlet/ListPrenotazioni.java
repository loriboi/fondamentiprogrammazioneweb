 ...
 * @author fpw
 */
@WebServlet(name = "ListPrenotazioni", urlPatterns = {"/ListPrenotazioni"})
public class ListPrenotazioni extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("gestisci_prenotazioni.jsp").forward(request,response);
    }
