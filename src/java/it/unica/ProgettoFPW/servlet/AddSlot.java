...
public class AddSlot extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            java.sql.Date today = Utils.dateOfToday();
            
            
            //Utils.checkDates(today, sqlData);
            
            int id_bagnino = new Integer(request.getParameter("bagn"));
            ...
            PostazioneFactory.getInstance().addSlot(sqlData,id_bagnino,posti_mattina,posti_sera);
            response.sendRedirect("admin");
        } catch (ParseException ex) {
            Logger.getLogger(AddSlot.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
